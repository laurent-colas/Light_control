...
char* locations[] = {"light1ON", "light1OFF","light2ON", "light2OFF","light3ON", "light3OFF","light4ON", "light4OFF"};
String location;
...
int ReadButton(int AnalogIn, int ButtonRead, int PreviousPressedButton) {
