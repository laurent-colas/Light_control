...
def activate_job():
    def init_macro_csv():
        ...
        with open('macro_list.csv', encoding='cp863') as csv_file:
...
def add_macros():
    ...
    if form.validate():
        ...
        with open('macro_list.csv', mode='a', encoding='cp863', newline='') as macro_list_file:
            print("Writing new macro info")
            test = macro_places[1:]
            print(name_new_macro)
            print('This includes: ' + str(test))
...
def brightness_button():
    ...
    if form.validate_on_submit():
        ...
        # print(light_address_brightness)
...
def button_map():
    ...
    # if form.validate_on_submit():
    #     button_name = request.form['submit']
    #     print(button_name)
    #     button_places = list_buttons[button_name]
    #     for key in button_places:
    #         list_places[key][0] = button_brightness
    #         final_target_pins = list_places[key][1:]
    #         final_state = list_places[key][0]
